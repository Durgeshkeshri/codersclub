...
const About = () => {
  ...
  return (
    ...
    <div className="xl:px-[8%] px-[6%] mt-6 text-center">
      <div className="flex flex-col justify-center items-center">
        <p className='tab:text-[51px] text-[29px] font-bold'>Meet The <span className='text-[#0080FF]'>Team</span></p>
        <p className='tab:text-[16px] text-[14px]'>At Coders Club, our dedicated team drives our success with expertise, creativity, and passion. Meet the individuals who make our community exceptional and help you thrive.</p>
      </div>
      <div className=""></div>
    </div>
    </div>
